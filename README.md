...
![Artificial Intelligence](https://img.shields.io/badge/AI_Tools-FF5733?style=for-the-badge&logo=openai&logoColor=white)
...
2025-2026
:   **Master, Full-Stack Web Developer**; [UNIR. Universidad Internacional de La Rioja](https://unir.es). (La Rioja, España)

    * Manejar el desarrollo front-end y el desarrollo back-end de las aplicaciones web y móviles. Descubre cómo plantear una estrategia de éxito a través de casos prácticos.
    * JavaScript: Un lenguaje de programación ligero e interpretado, utilizado por los desarrolladores para hacer páginas web interactivas. Permite crear experiencias dinámicas, desde efectos visuales hasta validaciones y manipulación de datos en tiempo real.
    * Angular: Un framework basado en TypeScript ideal para proyectos de alta complejidad que te permite construir aplicaciones web robustas y escalables.
    * Node JS: Un motor de ejecución de javascript fuera del navegador con el que podrás crear aplicaciones eficientes que manejan múltiples conexiones simultáneamente.
    * Entender y trabajar con lenguajes y tecnologías orientadas a la creación de aplicaciones en front y, a su vez, con herramientas para la gestión y programación de servidores en el back.
<br>
